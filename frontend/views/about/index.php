                    ...
                    <div class="row">
                     ...
                     <div class="row">
                        <div class="col-12 mox-padd-20">
                            ...
                            <div class="mox-padd-20"></div>
                                <p class="mox-left mox-red"><?php if(Yii::$app->language == 'ru')
                                            echo '
                                                    <ul class="label mox-justify mox-red">Эмблема нашего центра имеет форму полярного сияния, которая ассоциируется с Крайним Севером. 
                                                    Полярное сияние - символ совершенства, инноваций и потенциала. Этот символ был выбран потому, что он способен одновременно выражать все наши видения, наши ценности и идеи:
