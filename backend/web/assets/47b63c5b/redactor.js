    ...
    $.Redactor.opts = {
        ...
        langs: {
            en: {
                ...
                insert_column_left: 'Добавить столбик слева',
                insert_column_right: 'Добавить столбик справа',
                delete_column: 'Удалить столбик',
                delete_row: 'Удалить строку',
                delete_table: 'Удалить таблицу',
                rows: 'Строки',
                columns: 'Колонки',
                add_head: 'Добавить описание',
                delete_head: 'Удалить описание',
                title: 'Заголовок',
                ...
                right: 'Справа',
                center: 'По центру',
                image_web_link: 'Ссылка изображения',
                text: 'Текст',
                mailto: 'Email',
                web: 'URL',
                video_html_code: 'Код для вставки видео или Youtube / Video Ссылка',
                file: 'Добавить файл',
                upload: 'Загрузить',
                download: 'Скачать',
                choose: 'Выбрать',
                or_choose: 'или выбрать',
                drop_file_here: 'Вставить здесь',
                align_left: 'Вырвнивание по левой стороне',
